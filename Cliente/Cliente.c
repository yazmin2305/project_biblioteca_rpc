					...
					case 5:
						...
						if ((*objP).codigo == codPrestamo)
						{
							...
							if(*result_3 != 0){
								...
								printf("El usuario no tiene multas, puede hacerse la devolución del libro sin costo\n");
							}
				...
				do
				{
					...
					case 1:
						...
						if ((*result_6).codigo == buscarlibro_1_arg)
						{
							...
							printf("Autor: %s", (*result_6).autor);
							printf("Area de conocimiento: %s", (*result_6).areaConocimiento);
							printf("Editorial: %s", (*result_6).editorial);
							printf("Código: %d", (*result_6).codigo);
							printf("\n");
						}
						else
						{
